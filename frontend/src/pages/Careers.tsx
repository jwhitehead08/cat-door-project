                  ...
                  <Grid container spacing={2} alignItems="flex-start">
                    ...
                    <Grid size={{ xs: 12, sm: 'grow' }}>
                      <Box sx={{ display: 'flex', flexWrap: 'wrap', alignItems: 'center', gap: 1, mb: 0.5 }}>
                        ...
                        <Chip label={team} size="small" sx={{ backgroundColor: 'rgba(75,156,211,0.10)', color: 'secondary.dark' }} />
          ...
          {submitted ? (
            ...
            <Box component="form" onSubmit={handleSubmit} noValidate>
              <Stack spacing={3}>
                ...
                <TextField label="Role of Interest" name="role" value={form.role} onChange={handleChange} required fullWidth placeholder="e.g. Installation Specialist" />
                <TextField label="Tell us about yourself" name="message" value={form.message} onChange={handleChange} required multiline rows={5} fullWidth />
